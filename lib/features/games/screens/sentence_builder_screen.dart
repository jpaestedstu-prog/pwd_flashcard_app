...
class _SentenceBuilderScreenState extends ConsumerState<SentenceBuilderScreen>
  ...
  void _initCards() {
    ...
    source = source.where((c) => c.exampleSentence != null && c.exampleSentence!.isNotEmpty).toList();
  ...
  void _generateChoices() {
    ...
    final sameCategoryCards = SeedData.allFlashcards
        .where((c) =>
    ...
    final otherCards = SeedData.allFlashcards
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    // ─── Sentence with Blank ────────
                    Semantics(
                      label: 'Sentence: ${sentenceWithBlank.replaceAll('______', 'blank')}',
                      child: Container(
                        width: double.infinity,
                        padding: const EdgeInsets.all(24),
                        decoration: BoxDecoration(
                    ...
                    ...List.generate(_choices.length, (i) {
                      ...
                      return Padding(
                        ...
                        child: Semantics(
                          button: true,
                          label: '${_answered ? (isCorrectChoice ? "Correct answer" : (isSelected ? "Your wrong answer" : "")) : "Option"}: $choice',
